...
//		ChromeDriverManager.getInstance().setup();
		...
		Thread.sleep(4000L);
		driver.get("https://image.tripoto.com/image/generate/ss/img/403189/TripDocument/1497424269_img_8.jpg");
		Thread.sleep(4000L);
		...
		if (logs.getAll().size() > 0) {
			...
			driver.get("https://image.tripoto.com/media/transfer/img/403189/TripDocument/1497424269_img_8.jpg");
			Thread.sleep(4000L);
